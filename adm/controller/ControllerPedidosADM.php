...
if (isset($_REQUEST['selectOrdem']) && !empty($_REQUEST['selectOrdem'])) {
    ...
    $header = 'Location: ../view/listPedidos.php?selectOrdem=' . $exibSearch;
    ...
    $header = 'Location: ../view/listPedidos.php?selectStatus=' . $exibSearch;
    ...
    $header = 'Location: ../view/listPedidos.php?dataStart=' . $exibSearchStart . '&dataEnd=' . $exibSearchEnd;
...
?>
    <form action="../view/listPedidos.php" name="myForm" id="myForm" method="post">
