...
<head>
    ...
    <link rel="stylesheet" href="../assets/styles/politica-privacidade.css">
...
<body id="body-margin">
    <main class="container-politica">
        <article class="about-content">
            ...
            <p>A sua privacidade é importante para nós. É política do 2ucase respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=https://2ucase.fun/app/view/homepage.php>2UCASE</a>, e outros sites que possuímos e operamos.</p>
