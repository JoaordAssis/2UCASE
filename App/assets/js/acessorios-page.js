    ...
    if (opcaoTexto !== "Todos") {
        if (opcaoTexto === "0") {
            window.location.href =
                "../controllers/ControllerCategoria.php?category=" + categoria + "&selectOrdem=0" + opcaoTexto + "&acessorios=true";
        } else {
            window.location.href =
                "../controllers/ControllerCategoria.php?category=" + categoria + "&selectOrdem=" + opcaoTexto + "&acessorios=true";
        }
    }
