...
function redirectOrdem(search) {
    let opcaoTexto = selectOrdem.options[selectOrdem.selectedIndex].value;

    if (opcaoTexto !== "Todos") {
        if (opcaoTexto === "0") {
            window.location.href =
                "../controllers/ControllerSearchBar.php?search=" + search + "&selectOrdem=0" + opcaoTexto;
        } else {
            window.location.href =
                "../controllers/ControllerSearchBar.php?search=" + search + "&selectOrdem=" + opcaoTexto;
        }
    }
